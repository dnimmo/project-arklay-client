...
var _dnimmo$project_arklay_v2$Constants$transition = 'linear all .3s';
var _dnimmo$project_arklay_v2$Constants$colourPalette3 = _rtfeldman$elm_css$Css$hex('67707b');
var _dnimmo$project_arklay_v2$Constants$colourPalette2 = _rtfeldman$elm_css$Css$hex('fafafa');
var _dnimmo$project_arklay_v2$Constants$colourPalette1 = _rtfeldman$elm_css$Css$hex('141418');
...
var _dnimmo$project_arklay_v2$SiteText$stillEmptyRoom = 'Nope, there\'s still nothing here';
var _dnimmo$project_arklay_v2$SiteText$emptyRoom = 'There is nothing useful here';
var _dnimmo$project_arklay_v2$SiteText$closeInventory = 'Close';
var _dnimmo$project_arklay_v2$SiteText$openInventory = 'Inventory';
var _dnimmo$project_arklay_v2$SiteText$examine = 'Examine room';
var _dnimmo$project_arklay_v2$SiteText$startButton = 'Get started';
var _dnimmo$project_arklay_v2$SiteText$intro = 'Your head hurts. You\'re not sure where you are, and you definitely don\'t know how you got here. There\'s rain thrashing the ground all around you. You figure you might as well try and understand what the Hell is going on...';
var _dnimmo$project_arklay_v2$SiteText$header = 'Project Arklay';

var _dnimmo$project_arklay_v2$Rooms$list = {
	ctor: '::',
	_0: {
		name: 'Error',
		intro: 'You shouldn\'t be able to get here.',
		surroundings: 'If you have, something has gone wrong, and for that I apologise.',
		surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
		surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
		item: _elm_lang$core$Maybe$Nothing,
		availableDirections: {
			ctor: '::',
			_0: {text: 'Return', destination: 'Entrance', unlockedWith: _elm_lang$core$Maybe$Nothing},
			_1: {ctor: '[]'}
		}
	},
	_1: {
		...
		_0: {
			...
			availableDirections: {
				ctor: '::',
				_0: {text: 'Enter', destination: 'Entrance', unlockedWith: _elm_lang$core$Maybe$Nothing},
				_1: {ctor: '[]'}
			}
		},
		_1: {
			...
			_0: {
				...
				availableDirections: {
					ctor: '::',
					_0: {text: 'Upstairs', destination: 'Upstairs Foyer', unlockedWith: _elm_lang$core$Maybe$Nothing},
					_1: {
						ctor: '::',
						_0: {text: 'West', destination: 'Dining Hall', unlockedWith: _elm_lang$core$Maybe$Nothing},
						_1: {
							ctor: '::',
							_0: {text: 'East', destination: 'Hallway One', unlockedWith: _elm_lang$core$Maybe$Nothing},
							_1: {ctor: '[]'}
						}
					}
				}
			...
			_1: {
				...
				_0: {
					...
					availableDirections: {
						ctor: '::',
						_0: {text: 'North', destination: 'Upstairs Hallway One', unlockedWith: _elm_lang$core$Maybe$Nothing},
						_1: {
							ctor: '::',
							_0: {text: 'Downstairs', destination: 'Entrance', unlockedWith: _elm_lang$core$Maybe$Nothing},
							_1: {ctor: '[]'}
						}
					}
				},
				_1: {
					...
					_0: {
						...
						availableDirections: {
							ctor: '::',
							_0: {text: 'West', destination: 'Upstairs Study', unlockedWith: _elm_lang$core$Maybe$Nothing},
							_1: {
								ctor: '::',
								_0: {text: 'East', destination: 'Upstairs Third Bedroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
								_1: {
									ctor: '::',
									_0: {text: 'South', destination: 'Upstairs Foyer', unlockedWith: _elm_lang$core$Maybe$Nothing},
									_1: {ctor: '[]'}
								}
							}
						}
					...
					_1: {
						...
						_0: {
							...
							surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
							surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('A bookshelf has moved to one side, revealing a door to the West'),
							item: _elm_lang$core$Maybe$Nothing,
							availableDirections: {
								ctor: '::',
								_0: {text: 'North', destination: 'Upstairs Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
								_1: {
									ctor: '::',
									_0: {
										text: 'West',
										destination: 'Upstairs Secret Room Three',
										unlockedWith: _elm_lang$core$Maybe$Just(
											{
												ctor: '::',
												_0: 'Keycode',
												_1: {ctor: '[]'}
									...
									_1: {
										ctor: '::',
										_0: {text: 'East', destination: 'Upstairs Hallway One', unlockedWith: _elm_lang$core$Maybe$Nothing},
										_1: {ctor: '[]'}
									}
								}
							}
						...
						_1: {
							...
							_0: {
								...
								surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('The room is completely empty. The podium stands bare.'),
								surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
								item: _elm_lang$core$Maybe$Just('Lion Crest'),
								availableDirections: {
									ctor: '::',
									_0: {
										text: 'East',
							...
							_1: {
								...
								_0: {
									...
									surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
									surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('Looks like it needs three crests to open'),
									item: _elm_lang$core$Maybe$Nothing,
									availableDirections: {
										ctor: '::',
										_0: {
										...
										_1: {
											ctor: '::',
											_0: {text: 'East', destination: 'Upstairs Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
											_1: {
												ctor: '::',
												_0: {text: 'Downstairs', destination: 'Stairway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
												_1: {ctor: '[]'}
											}
										}
									}
								...
								_1: {
									...
									_0: {
										...
										availableDirections: {
											ctor: '::',
											_0: {text: 'West', destination: 'Upstairs Master En Suite', unlockedWith: _elm_lang$core$Maybe$Nothing},
											_1: {
												ctor: '::',
												_0: {
													text: 'South',
									...
									_1: {
										...
										_0: {
											...
											surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
											surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('Empty wine glasses stand on the floor by the bath.'),
											item: _elm_lang$core$Maybe$Just('Wine Bottle'),
											availableDirections: {
												ctor: '::',
												_0: {text: 'East', destination: 'Upstairs Master Bedroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
												_1: {ctor: '[]'}
											}
										},
										_1: {
											...
											_0: {
												...
												availableDirections: {
													ctor: '::',
													_0: {text: 'West', destination: 'Upstairs Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
													_1: {
														ctor: '::',
														_0: {text: 'Downstairs', destination: 'Stairway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
														_1: {ctor: '[]'}
													}
												}
											},
											_1: {
												...
												_0: {
													...
													availableDirections: {
														ctor: '::',
														_0: {text: 'North', destination: 'Upstairs Trophy Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
														_1: {
															ctor: '::',
															_0: {text: 'West', destination: 'Upstairs Stairway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
															_1: {
																ctor: '::',
																_0: {text: 'East', destination: 'Upstairs Art Gallery', unlockedWith: _elm_lang$core$Maybe$Nothing},
																_1: {
																	ctor: '::',
																	_0: {text: 'South', destination: 'Upstairs Study', unlockedWith: _elm_lang$core$Maybe$Nothing},
																	_1: {ctor: '[]'}
																}
															}
														}
												...
												_1: {
													...
													_0: {
														...
														availableDirections: {
															ctor: '::',
															_0: {text: 'West', destination: 'Upstairs Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
															_1: {
																ctor: '::',
																_0: {text: 'East', destination: 'Upstairs Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																_1: {ctor: '[]'}
															}
														}
													},
													_1: {
														...
														_0: {
															...
															surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('There are doors in every direction.'),
															surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
															item: _elm_lang$core$Maybe$Nothing,
															availableDirections: {
																ctor: '::',
																...
																_1: {
																	ctor: '::',
																	_0: {text: 'West', destination: 'Upstairs Art Gallery', unlockedWith: _elm_lang$core$Maybe$Nothing},
																	_1: {
																		ctor: '::',
																		_0: {text: 'East', destination: 'Upstairs Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
																		_1: {
																			ctor: '::',
																			_0: {text: 'South', destination: 'Upstairs Library', unlockedWith: _elm_lang$core$Maybe$Nothing},
																			_1: {ctor: '[]'}
																		}
																	}
																}
														...
														_1: {
															...
															_0: {
																...
																surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('The air in here is crisp, and salty. How long have the fish been dead though? What happened in this house?'),
																item: _elm_lang$core$Maybe$Just('Utility Key'),
																availableDirections: {
																	ctor: '::',
																	_0: {text: 'South', destination: 'Upstairs Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																	_1: {ctor: '[]'}
																}
															},
															_1: {
																...
																_0: {
																	...
																	surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																	surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('There are many, many books in here. There isn\'t time to look through them all.'),
																	item: _elm_lang$core$Maybe$Just('Sheet Music'),
																	availableDirections: {
																		ctor: '::',
																		_0: {text: 'North', destination: 'Upstairs Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																		_1: {ctor: '[]'}
																	}
																},
																_1: {
																	...
																	_0: {
																		...
																		availableDirections: {
																			ctor: '::',
																			_0: {text: 'West', destination: 'Upstairs Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																			_1: {
																				ctor: '::',
																				_0: {text: 'East', destination: 'Upstairs Stairway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																				_1: {
																					ctor: '::',
																					_0: {text: 'South', destination: 'Upstairs Second Bedroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																					_1: {ctor: '[]'}
																				}
																			}
																		}
																	...
																	_1: {
																		...
																		_0: {
																			...
																			availableDirections: {
																				ctor: '::',
																				_0: {text: 'North', destination: 'Upstairs Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
																				_1: {
																					ctor: '::',
																					_0: {text: 'South', destination: 'Upstairs Second Bathroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																					_1: {ctor: '[]'}
																				}
																			}
																		},
																		_1: {
																			...
																			_0: {
																				...
																				availableDirections: {
																					ctor: '::',
																					_0: {text: 'North', destination: 'Upstairs Second Bedroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																					_1: {
																						ctor: '::',
																						_0: {text: 'West', destination: 'Upstairs Third Bedroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																						_1: {ctor: '[]'}
																					}
																				}
																			},
																			_1: {
																				...
																				_0: {
																					...
																					availableDirections: {
																						ctor: '::',
																						_0: {text: 'West', destination: 'Upstairs Hallway One', unlockedWith: _elm_lang$core$Maybe$Nothing},
																						_1: {
																							ctor: '::',
																							_0: {text: 'East', destination: 'Upstairs Second Bathroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																							_1: {ctor: '[]'}
																						}
																					}
																				},
																				_1: {
																					...
																					_0: {
																						...
																						availableDirections: {
																							ctor: '::',
																							_0: {text: 'South', destination: 'Upstairs Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																							_1: {ctor: '[]'}
																						}
																					},
																					_1: {
																						...
																						_0: {
																							...
																							availableDirections: {
																								ctor: '::',
																								_0: {text: 'North', destination: 'Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																								_1: {
																									ctor: '::',
																									_0: {text: 'East', destination: 'Entrance', unlockedWith: _elm_lang$core$Maybe$Nothing},
																									_1: {ctor: '[]'}
																								}
																							}
																						},
																						_1: {
																							...
																							_0: {
																								...
																								surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('The stench in here is almost overwhelming now.'),
																								surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																								item: _elm_lang$core$Maybe$Nothing,
																								availableDirections: {
																									ctor: '::',
																									_0: {text: 'North', destination: 'Kitchen', unlockedWith: _elm_lang$core$Maybe$Nothing},
																									_1: {
																										ctor: '::',
																										_0: {text: 'West', destination: 'Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
																										_1: {
																											ctor: '::',
																											_0: {
																												text: 'East',
																											...
																											_1: {
																												ctor: '::',
																												_0: {text: 'South', destination: 'Dining Hall', unlockedWith: _elm_lang$core$Maybe$Nothing},
																												_1: {ctor: '[]'}
																											}
																										}
																									}
																							...
																							_1: {
																								...
																								_0: {
																									...
																									availableDirections: {
																										ctor: '::',
																										_0: {text: 'West', destination: 'Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																										_1: {
																											ctor: '::',
																											_0: {text: 'Downstairs', destination: 'Basement Stairway', unlockedWith: _elm_lang$core$Maybe$Nothing},
																											_1: {ctor: '[]'}
																										}
																									}
																								},
																								_1: {
																									...
																									_0: {
																										...
																										availableDirections: {
																											ctor: '::',
																											_0: {text: 'North', destination: 'Waste Disposal', unlockedWith: _elm_lang$core$Maybe$Nothing},
																											_1: {
																												ctor: '::',
																												_0: {text: 'East', destination: 'Freezer', unlockedWith: _elm_lang$core$Maybe$Nothing},
																												_1: {
																													ctor: '::',
																													_0: {text: 'South', destination: 'Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																													_1: {ctor: '[]'}
																												}
																											}
																										}
																									...
																									_1: {
																										...
																										_0: {
																											...
																											surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																											surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('It\'s full of mountains of meat. Why was there a moose head in here?'),
																											item: _elm_lang$core$Maybe$Just('Moose Head'),
																											availableDirections: {
																												ctor: '::',
																												_0: {text: 'West', destination: 'Kitchen', unlockedWith: _elm_lang$core$Maybe$Nothing},
																												_1: {ctor: '[]'}
																											}
																										},
																										_1: {
																											...
																											_0: {
																												...
																												surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('What could be at the bottom?'),
																												surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																												item: _elm_lang$core$Maybe$Nothing,
																												availableDirections: {
																													ctor: '::',
																													...
																													_1: {
																														ctor: '::',
																														_0: {text: 'South', destination: 'Kitchen', unlockedWith: _elm_lang$core$Maybe$Nothing},
																														_1: {ctor: '[]'}
																													}
																												}
																											},
																											_1: {
																												...
																												_0: {
																													...
																													availableDirections: {
																														ctor: '::',
																														_0: {text: 'North', destination: 'Stairway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																														_1: {
																															ctor: '::',
																															_0: {text: 'West', destination: 'Music Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																															_1: {
																																ctor: '::',
																																_0: {text: 'East', destination: 'Hallway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																_1: {ctor: '[]'}
																															}
																														}
																													}
																												...
																												_1: {
																													...
																													_0: {
																														...
																														availableDirections: {
																															ctor: '::',
																															_0: {text: 'Upstairs', destination: 'Upstairs Stairway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																															_1: {
																																ctor: '::',
																																_0: {text: 'South', destination: 'Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																_1: {ctor: '[]'}
																															}
																														}
																													},
																													_1: {
																														...
																														_0: {
																															...
																															surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('A wall has moved, revealing a hidden room behind it.'),
																															surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																															item: _elm_lang$core$Maybe$Nothing,
																															availableDirections: {
																																ctor: '::',
																																_0: {text: 'North', destination: 'Hallway Five', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																_1: {
																																	ctor: '::',
																																	_0: {text: 'East', destination: 'Hallway Four', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																	_1: {
																																		ctor: '::',
																																		_0: {
																																			text: 'South',
																														...
																														_1: {
																															...
																															_0: {
																																...
																																availableDirections: {
																																	ctor: '::',
																																	_0: {text: 'North', destination: 'Gym', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																	_1: {
																																		ctor: '::',
																																		_0: {text: 'South', destination: 'Music Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																		_1: {ctor: '[]'}
																																	}
																																}
																															},
																															_1: {
																																...
																																_0: {
																																	...
																																	surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																	surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('This is nicer than any gym I\'ve ever been to.'),
																																	item: _elm_lang$core$Maybe$Just('Keycode'),
																																	availableDirections: {
																																		ctor: '::',
																																		_0: {text: 'East', destination: 'Swimming Pool', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																		_1: {
																																			ctor: '::',
																																			_0: {text: 'South', destination: 'Hallway Five', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																			_1: {ctor: '[]'}
																																		}
																																	}
																																},
																																_1: {
																																	...
																																	_0: {
																																		...
																																		availableDirections: {
																																			ctor: '::',
																																			_0: {text: 'West', destination: 'Gym', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																			_1: {
																																				ctor: '::',
																																				_0: {text: 'East', destination: 'Showers', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																				_1: {ctor: '[]'}
																																			}
																																		}
																																	},
																																	_1: {
																																		...
																																		_0: {
																																			...
																																			availableDirections: {
																																				ctor: '::',
																																				_0: {text: 'West', destination: 'Swimming Pool', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																				_1: {ctor: '[]'}
																																			}
																																		},
																																		_1: {
																																			...
																																			_0: {
																																				...
																																				surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																				surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('The room is completely empty, except for the podium in the middle, where you found a crest.'),
																																				item: _elm_lang$core$Maybe$Just('Eagle Crest'),
																																				availableDirections: {
																																					ctor: '::',
																																					_0: {text: 'North', destination: 'Music Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																					_1: {ctor: '[]'}
																																				}
																																			},
																																			_1: {
																																				...
																																				_0: {
																																					...
																																					availableDirections: {
																																						ctor: '::',
																																						_0: {text: 'North', destination: 'Statue Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																						_1: {
																																							ctor: '::',
																																							_0: {text: 'West', destination: 'Entrance', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																							_1: {ctor: '[]'}
																																						}
																																					}
																																				},
																																				_1: {
																																					...
																																					_0: {
																																						...
																																						surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('At least they aren\'t mannequins, but statues aren\'t much better. One of them has moved aside, revealing a hidden doorway.'),
																																						surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																																						item: _elm_lang$core$Maybe$Nothing,
																																						availableDirections: {
																																							ctor: '::',
																																							...
																																							_1: {
																																								ctor: '::',
																																								_0: {text: 'East', destination: 'Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																								_1: {
																																									ctor: '::',
																																									_0: {text: 'South', destination: 'Hallway One', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																									_1: {ctor: '[]'}
																																								}
																																							}
																																						}
																																					...
																																					_1: {
																																						...
																																						_0: {
																																							...
																																							surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																							surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('An empty room, except for a lonely looking concrete podium in the middle.'),
																																							item: _elm_lang$core$Maybe$Just('Wolf Crest'),
																																							availableDirections: {
																																								ctor: '::',
																																								_0: {text: 'South', destination: 'Statue Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																								_1: {ctor: '[]'}
																																							}
																																						},
																																						_1: {
																																							...
																																							_0: {
																																								...
																																								surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('This hallway is quite large. The door to the servants\' quarters is unlocked.'),
																																								surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																																								item: _elm_lang$core$Maybe$Nothing,
																																								availableDirections: {
																																									ctor: '::',
																																									...
																																									_1: {
																																										ctor: '::',
																																										_0: {text: 'West', destination: 'Statue Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																										_1: {
																																											ctor: '::',
																																											_0: {text: 'East', destination: 'Stairway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																											_1: {
																																												ctor: '::',
																																												_0: {text: 'South', destination: 'Garage', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																												_1: {ctor: '[]'}
																																											}
																																										}
																																									}
																																							...
																																							_1: {
																																								...
																																								_0: {
																																									...
																																									surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																									surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('The garage is empty, apart from a few tools.'),
																																									item: _elm_lang$core$Maybe$Just('Crowbar'),
																																									availableDirections: {
																																										ctor: '::',
																																										_0: {text: 'North', destination: 'Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																										_1: {ctor: '[]'}
																																									}
																																								},
																																								_1: {
																																									...
																																									_0: {
																																										...
																																										surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																										surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('It\'s actaully pretty nice in here. But who were these people serving?'),
																																										item: _elm_lang$core$Maybe$Just('Statue Head'),
																																										availableDirections: {
																																											ctor: '::',
																																											_0: {text: 'West', destination: 'Servants\' Bathroom', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																											_1: {
																																												ctor: '::',
																																												_0: {
																																													text: 'South',
																																									...
																																									_1: {
																																										...
																																										_0: {
																																											...
																																											availableDirections: {
																																												ctor: '::',
																																												_0: {text: 'East', destination: 'Servants\' Quarters', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																												_1: {ctor: '[]'}
																																											}
																																										},
																																										_1: {
																																											...
																																											_0: {
																																												...
																																												availableDirections: {
																																													ctor: '::',
																																													_0: {text: 'Upstairs', destination: 'Upstairs Stairway Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																													_1: {
																																														ctor: '::',
																																														_0: {text: 'West', destination: 'Hallway Three', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																														_1: {ctor: '[]'}
																																													}
																																												}
																																											},
																																											_1: {
																																												...
																																												_0: {
																																													...
																																													availableDirections: {
																																														ctor: '::',
																																														_0: {text: 'Upstairs', destination: 'Utility Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																														_1: {
																																															ctor: '::',
																																															_0: {text: 'West', destination: 'Basement Storage', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																															_1: {
																																																ctor: '::',
																																																_0: {text: 'East', destination: 'Basement Storage Two', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																_1: {
																																																	ctor: '::',
																																																	_0: {text: 'South', destination: 'Basement Wine Cellar', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																	_1: {ctor: '[]'}
																																																}
																																															}
																																														}
																																												...
																																												_1: {
																																													...
																																													_0: {
																																														...
																																														availableDirections: {
																																															ctor: '::',
																																															_0: {text: 'East', destination: 'Basement Stairway', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																															_1: {ctor: '[]'}
																																														}
																																													},
																																													_1: {
																																														...
																																														_0: {
																																															...
																																															surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																															surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('There\'s nothing to see here.'),
																																															item: _elm_lang$core$Maybe$Just('Handle'),
																																															availableDirections: {
																																																ctor: '::',
																																																_0: {text: 'West', destination: 'Basement Stairway', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																_1: {ctor: '[]'}
																																															}
																																														},
																																														_1: {
																																															...
																																															_0: {
																																																...
																																																surroundingsWhenItemUsed: _elm_lang$core$Maybe$Nothing,
																																																surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Just('There\'s nothing interesting in here any more.'),
																																																item: _elm_lang$core$Maybe$Just('Small Key'),
																																																availableDirections: {
																																																	ctor: '::',
																																																	_0: {text: 'South', destination: 'Basement Storage', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																	_1: {ctor: '[]'}
																																																}
																																															},
																																															_1: {
																																																...
																																																_0: {
																																																	...
																																																	availableDirections: {
																																																		ctor: '::',
																																																		_0: {text: 'East', destination: 'Basement Item Room', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																		_1: {ctor: '[]'}
																																																	}
																																																},
																																																_1: {
																																																	...
																																																	_0: {
																																																		...
																																																		surroundingsWhenItemUsed: _elm_lang$core$Maybe$Just('One of the racks has moved, revealing a hidden doorway.'),
																																																		surroundingsWhenItemPickedUp: _elm_lang$core$Maybe$Nothing,
																																																		item: _elm_lang$core$Maybe$Nothing,
																																																		availableDirections: {
																																																			ctor: '::',
																																																			_0: {text: 'North', destination: 'Basement Stairway', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																			_1: {
																																																				ctor: '::',
																																																				_0: {
																																																					text: 'West',
																																																	...
																																																	_1: {
																																																		...
																																																		_0: {
																																																			...
																																																			availableDirections: {
																																																				ctor: '::',
																																																				_0: {text: 'End Game', destination: 'End', unlockedWith: _elm_lang$core$Maybe$Nothing},
																																																				_1: {ctor: '[]'}
																																																			}
																																																		},
																																																		_1: {
...
var _dnimmo$project_arklay_v2$Rooms$Room = F7(
	function (a, b, c, d, e, f, g) {
		return {name: a, intro: b, surroundings: c, surroundingsWhenItemPickedUp: d, surroundingsWhenItemUsed: e, item: f, availableDirections: g};
	});
var _dnimmo$project_arklay_v2$Rooms$Direction = F3(
	function (a, b, c) {
		return {text: a, destination: b, unlockedWith: c};
	});

var _dnimmo$project_arklay_v2$Map$rooms = _dnimmo$project_arklay_v2$Rooms$list;
var _dnimmo$project_arklay_v2$Map$getUsableItems = function (directions) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			function (direction) {
				return A2(
					...
					direction.unlockedWith);
			},
			directions));
};
var _dnimmo$project_arklay_v2$Map$getRoom = function (roomName) {
	var roomToReturn = _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (room) {
				return _elm_lang$core$Native_Utils.eq(room.name, roomName);
			},
			_dnimmo$project_arklay_v2$Map$rooms));
	var _p0 = roomToReturn;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _dnimmo$project_arklay_v2$Map$errorRoom;
	}
};
var _dnimmo$project_arklay_v2$Map$errorRoom = _dnimmo$project_arklay_v2$Map$getRoom('Error');
var _dnimmo$project_arklay_v2$Map$startingRoom = _dnimmo$project_arklay_v2$Map$getRoom('Start');

var _dnimmo$project_arklay_v2$Items$list = {
	ctor: '::',
	_0: {name: 'Error', description: 'You shouldn\'t be able to see this. If you can, something has gone wrong.', messageWhenUsed: '', messageWhenNotUsed: ''},
	_1: {
		ctor: '::',
		_0: {name: 'Lion Crest', description: 'A crest, with a lion\'s head on the front.', messageWhenUsed: 'You place the crest into the door', messageWhenNotUsed: 'Cool lion, but what could this be for?'},
		_1: {
			ctor: '::',
			_0: {name: 'Wine Bottle', description: 'An expensive-looking bottle of wine.', messageWhenUsed: 'You place the wine bottle back in the rack', messageWhenNotUsed: 'It\'s a shame this is empty. Some wine would be good right now.'},
			_1: {
				ctor: '::',
				_0: {name: 'Utility Key', description: 'A small key, with a tag that reads \"Utility\".', messageWhenUsed: 'You unlock the door to the utility room', messageWhenNotUsed: 'This key doesn\'t seem to fit any locks here.'},
				_1: {
					ctor: '::',
					_0: {name: 'Sheet Music', description: 'Sheet music for Beethoven\'s Piano Sonata No. 14.', messageWhenUsed: 'You play the piano', messageWhenNotUsed: 'An excellent piece of music. Though I\'m not sure why I decided to steal it'},
					_1: {
						ctor: '::',
						_0: {name: 'Moose Head', description: 'A moose\'s head. Its cold, dead eyes stare at you, looking lost and lonely.', messageWhenUsed: 'Ah, that\'s better', messageWhenNotUsed: 'I will not rest until this is back where it belongs'},
						_1: {
							ctor: '::',
							_0: {name: 'Keycode', description: 'A piece of paper with \"2407\" written on it.', messageWhenUsed: 'You enter the keycode into the terminal', messageWhenNotUsed: 'What could these numbers mean?'},
							_1: {
								ctor: '::',
								_0: {name: 'Eagle Crest', description: 'A crest, with an eagle\'s head on the front.', messageWhenUsed: 'You place the crest into the door', messageWhenNotUsed: 'What is this for? What does the eagle signify?'},
								_1: {
									ctor: '::',
									_0: {name: 'Crowbar', description: 'A sturdy crowbar.', messageWhenUsed: 'You prise off the wooden planks', messageWhenNotUsed: 'Nothing to use this on in here.'},
									_1: {
										ctor: '::',
										_0: {name: 'Statue Head', description: 'The head of a small statue.', messageWhenUsed: 'You place the head carefully back onto the statue', messageWhenNotUsed: 'What a strange thing to have found. I wonder who it\'s meant to be?'},
										_1: {
											ctor: '::',
											_0: {name: 'Handle', description: 'A metal handle. It looks like it\'s for some sort of trap door.', messageWhenUsed: 'You have attached the handle', messageWhenNotUsed: 'I\'m not sure where I could put this.'},
											_1: {
												ctor: '::',
												_0: {name: 'Small Key', description: 'A small key, with a tag that reads \"S.Q.\"', messageWhenUsed: 'You unlock the door', messageWhenNotUsed: 'It doesn\'t look like this can be used here'},
												_1: {
													ctor: '::',
													_0: {name: 'Wolf Crest', description: 'A crest with a wolf on it. Very unusual.', messageWhenUsed: 'You place the crest into the door', messageWhenNotUsed: 'What could this be for?'},
													_1: {ctor: '[]'}
												}
											}
										}
...
var _dnimmo$project_arklay_v2$Items$Item = F4(
	function (a, b, c, d) {
		return {name: a, description: b, messageWhenUsed: c, messageWhenNotUsed: d};
	});

var _dnimmo$project_arklay_v2$Inventory$displayMessage = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				function () {
					var _p0 = model.messageToDisplay;
					if (_p0.ctor === 'Just') {
						return A2(
							_elm_lang$core$Basics_ops['++'],
							'== ',
...
var _dnimmo$project_arklay_v2$Inventory$items = _dnimmo$project_arklay_v2$Items$list;
var _dnimmo$project_arklay_v2$Inventory$checkForItem = F2(
	function (itemToCheck, itemsList) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (item) {
					return _elm_lang$core$Native_Utils.eq(item.name, itemToCheck);
				},
				itemsList));
	});
var _dnimmo$project_arklay_v2$Inventory$getItem = function (itemName) {
	getItem:
	while (true) {
		var itemToReturn = A2(_dnimmo$project_arklay_v2$Inventory$checkForItem, itemName, _dnimmo$project_arklay_v2$Inventory$items);
		var _p1 = itemToReturn;
		if (_p1.ctor === 'Just') {
			return _p1._0;
		} else {
			var _v2 = 'Error';
...
var _dnimmo$project_arklay_v2$Inventory$addItem = F2(
	function (itemToAdd, model) {
		var itemAlreadyHeld = A2(
			_dnimmo$project_arklay_v2$Inventory$checkForItem,
			itemToAdd,
			A2(_elm_lang$core$Basics_ops['++'], model.items, model.itemsUsed));
		var _p2 = itemAlreadyHeld;
		if (_p2.ctor === 'Just') {
			return model.items;
		} else {
			return {
				ctor: '::',
				_0: _dnimmo$project_arklay_v2$Inventory$getItem(itemToAdd),
				_1: model.items
			};
		}
	});
var _dnimmo$project_arklay_v2$Inventory$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'AddItem':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						items: A2(_dnimmo$project_arklay_v2$Inventory$addItem, _p3._0, model)
					});
			case 'UseItem':
				var _p4 = _p3._0;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						items: A2(
							_elm_lang$core$List$filter,
							function (item) {
								return !_elm_lang$core$Native_Utils.eq(item, _p4);
							},
							model.items),
						itemsUsed: {ctor: '::', _0: _p4, _1: model.itemsUsed},
						open: false
					});
			case 'OpenInventory':
				return _elm_lang$core$Native_Utils.update(
			...
			case 'CloseInventory':
				return _elm_lang$core$Native_Utils.update(
					model,
					{open: false, messageToDisplay: _elm_lang$core$Maybe$Nothing});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						messageToDisplay: _elm_lang$core$Maybe$Just(_p3._0)
					});
		}
	});
var _dnimmo$project_arklay_v2$Inventory$itemsTouched = function (inventory) {
	return A2(
		_elm_lang$core$List$map,
		function (item) {
			return item.name;
		},
		A2(_elm_lang$core$Basics_ops['++'], inventory.items, inventory.itemsUsed));
};
var _dnimmo$project_arklay_v2$Inventory$initModel = {
	items: {ctor: '[]'},
	itemsUsed: {ctor: '[]'},
	open: false,
	messageToDisplay: _elm_lang$core$Maybe$Nothing
};
var _dnimmo$project_arklay_v2$Inventory$Model = F4(
	function (a, b, c, d) {
		return {items: a, itemsUsed: b, open: c, messageToDisplay: d};
	});
var _dnimmo$project_arklay_v2$Inventory$UpdateMessage = function (a) {
	return {ctor: 'UpdateMessage', _0: a};
};
var _dnimmo$project_arklay_v2$Inventory$CloseInventory = {ctor: 'CloseInventory'};
var _dnimmo$project_arklay_v2$Inventory$closeButton = A2(
	_elm_lang$html$Html$p,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('Selectable Inventory Separate'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_dnimmo$project_arklay_v2$Inventory$CloseInventory),
			_1: {ctor: '[]'}
		}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$closeInventory),
		_1: {ctor: '[]'}
	});
var _dnimmo$project_arklay_v2$Inventory$OpenInventory = {ctor: 'OpenInventory'};
var _dnimmo$project_arklay_v2$Inventory$inventoryButton = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('NotSelectable Inventory'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$openInventory),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('Selectable Inventory'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_dnimmo$project_arklay_v2$Inventory$OpenInventory),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _dnimmo$project_arklay_v2$Inventory$UseItem = function (a) {
	return {ctor: 'UseItem', _0: a};
};
var _dnimmo$project_arklay_v2$Inventory$renderItem = function (item) {
	return A2(
		_elm_lang$html$Html$li,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_dnimmo$project_arklay_v2$Inventory$UseItem(item)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _dnimmo$project_arklay_v2$Inventory$renderItems = function (items) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _dnimmo$project_arklay_v2$Inventory$renderItem, items));
};
var _dnimmo$project_arklay_v2$Inventory$view = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.open, true) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('UserOptions'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _dnimmo$project_arklay_v2$Inventory$displayMessage(model),
			_1: {
				ctor: '::',
				_0: _dnimmo$project_arklay_v2$Inventory$renderItems(model.items),
				_1: {
					ctor: '::',
					_0: _dnimmo$project_arklay_v2$Inventory$closeButton,
					_1: {ctor: '[]'}
				}
			}
		}) : _dnimmo$project_arklay_v2$Inventory$inventoryButton(model);
};
var _dnimmo$project_arklay_v2$Inventory$AddItem = function (a) {
	return {ctor: 'AddItem', _0: a};
};

var _dnimmo$project_arklay_v2$Game$displayNothing = _elm_lang$html$Html$text('');
var _dnimmo$project_arklay_v2$Game$roomIsUnlocked = F2(
	function (unlockRequirements, itemsUsed) {
		var requirementsMet = A2(
			_elm_lang$core$List$map,
		...
		return A2(
			_elm_lang$core$List$all,
			function (result) {
				return _elm_lang$core$Native_Utils.eq(result, true);
			},
			requirementsMet);
	});
var _dnimmo$project_arklay_v2$Game$roomIsOpen = F2(
	function (direction, itemsUsed) {
		var _p0 = direction.unlockedWith;
		if (_p0.ctor === 'Just') {
			return A2(_dnimmo$project_arklay_v2$Game$roomIsUnlocked, _p0._0, itemsUsed);
		} else {
			return true;
		}
	});
var _dnimmo$project_arklay_v2$Game$renderRoomInfo = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('RoomDescription'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(model.previousDirection),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.room.intro),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.room.surroundings),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _dnimmo$project_arklay_v2$Game$hasUnlockRequirements = function (direction) {
	var _p1 = direction.unlockedWith;
	if (_p1.ctor === 'Just') {
		return true;
	} else {
		return false;
...
var _dnimmo$project_arklay_v2$Game$itemCanBeUsed = function (directions) {
	return A2(_elm_lang$core$List$any, _dnimmo$project_arklay_v2$Game$hasUnlockRequirements, directions);
};
var _dnimmo$project_arklay_v2$Game$itemHasBeenUsed = F2(
	function (directions, usedItems) {
		return _dnimmo$project_arklay_v2$Game$itemCanBeUsed(directions) ? A2(
			_elm_lang$core$List$any,
			function (x) {
			...
			A2(
				...
				function (item) {
					return A2(
						_elm_lang$core$List$member,
						item.name,
						_dnimmo$project_arklay_v2$Map$getUsableItems(directions));
				},
				usedItems)) : false;
	});
var _dnimmo$project_arklay_v2$Game$itemHasBeenPickedUp = F2(
	function (item, inventory) {
		...
		if (_p2.ctor === 'Just') {
			return A2(
				_elm_lang$core$List$member,
				_p2._0,
				_dnimmo$project_arklay_v2$Inventory$itemsTouched(inventory));
		} else {
			return false;
		}
	});
var _dnimmo$project_arklay_v2$Game$roomHasItem = function (room) {
	var _p3 = room.item;
	if (_p3.ctor === 'Just') {
		return true;
	} else {
...
var _dnimmo$project_arklay_v2$Game$getLatestRoomInfo = F2(
	function (room, inventory) {
		if (_dnimmo$project_arklay_v2$Game$roomHasItem(room) && A2(_dnimmo$project_arklay_v2$Game$itemHasBeenPickedUp, room.item, inventory)) {
			var _p4 = room.surroundingsWhenItemPickedUp;
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.update(
					room,
					{surroundings: _p4._0});
			...
			if (_dnimmo$project_arklay_v2$Game$itemCanBeUsed(room.availableDirections) && A2(_dnimmo$project_arklay_v2$Game$itemHasBeenUsed, room.availableDirections, inventory.itemsUsed)) {
				var _p5 = room.surroundingsWhenItemUsed;
				if (_p5.ctor === 'Just') {
					return _elm_lang$core$Native_Utils.update(
						room,
						{surroundings: _p5._0});
...
var _dnimmo$project_arklay_v2$Game$update = F2(
	function (msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'ChangeRoom':
				return _elm_lang$core$Native_Utils.update(
					...
					{
						room: A2(
							_dnimmo$project_arklay_v2$Game$getLatestRoomInfo,
							_dnimmo$project_arklay_v2$Map$getRoom(_p6._0),
							model.inventory),
						displayedMessage: _elm_lang$core$Maybe$Nothing,
						previousDirection: A2(_elm_lang$core$Basics_ops['++'], 'From', _p6._1)
					});
			case 'ExamineRoom':
				var _p7 = _p6._0.item;
				if (_p7.ctor === 'Just') {
					var _p8 = _p7._0;
					var itemAlreadyPickedUp = A2(
						_dnimmo$project_arklay_v2$Game$itemHasBeenPickedUp,
						_elm_lang$core$Maybe$Just(_p8),
						model.inventory);
					var messageToDisplay = (!itemAlreadyPickedUp) ? _elm_lang$core$Maybe$Just(
						A2(_elm_lang$core$Basics_ops['++'], _p8, ' has been added to your inventory')) : _elm_lang$core$Maybe$Just(
						A2(_elm_lang$core$Basics_ops['++'], 'This was where I found the ', _p8));
					var modelWithNewItem = _elm_lang$core$Native_Utils.update(
						model,
						{
							inventory: A2(
								_dnimmo$project_arklay_v2$Inventory$update,
								_dnimmo$project_arklay_v2$Inventory$AddItem(_p8),
								model.inventory)
						});
					return _elm_lang$core$Native_Utils.update(
						modelWithNewItem,
						{
							room: A2(_dnimmo$project_arklay_v2$Game$getLatestRoomInfo, modelWithNewItem.room, modelWithNewItem.inventory),
							displayedMessage: messageToDisplay,
							examinedRooms: A2(_elm_lang$core$List$member, model.room, model.examinedRooms) ? model.examinedRooms : {ctor: '::', _0: model.room, _1: model.examinedRooms}
						});
				} else {
					return (!A2(_elm_lang$core$List$member, model.room, model.examinedRooms)) ? _elm_lang$core$Native_Utils.update(
						model,
						{
							displayedMessage: _elm_lang$core$Maybe$Just(_dnimmo$project_arklay_v2$SiteText$emptyRoom),
							examinedRooms: {ctor: '::', _0: model.room, _1: model.examinedRooms}
						}) : _elm_lang$core$Native_Utils.update(
						model,
						{
							displayedMessage: _elm_lang$core$Maybe$Just(_dnimmo$project_arklay_v2$SiteText$stillEmptyRoom)
						});
				}
			default:
				var _p11 = _p6._0;
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						inventory: A2(_dnimmo$project_arklay_v2$Inventory$update, _p11, model.inventory)
					});
				var modelToReturn = function () {
					var _p9 = _p11;
					if (_p9.ctor === 'UseItem') {
						var _p10 = _p9._0;
						return A2(
							_elm_lang$core$List$member,
							_p10.name,
							_dnimmo$project_arklay_v2$Map$getUsableItems(model.room.availableDirections)) ? _elm_lang$core$Native_Utils.update(
							updatedModel,
							{
								room: A2(_dnimmo$project_arklay_v2$Game$getLatestRoomInfo, model.room, updatedModel.inventory),
								displayedMessage: _elm_lang$core$Maybe$Just(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'== ',
										A2(_elm_lang$core$Basics_ops['++'], _p10.messageWhenUsed, ' ==')))
							}) : _elm_lang$core$Native_Utils.update(
							model,
							{
								inventory: A2(
									_dnimmo$project_arklay_v2$Inventory$update,
									_dnimmo$project_arklay_v2$Inventory$UpdateMessage(_p10.messageWhenNotUsed),
									model.inventory)
							});
					} else {
						return _elm_lang$core$Native_Utils.update(
...
var _dnimmo$project_arklay_v2$Game$initModel = {
	room: _dnimmo$project_arklay_v2$Map$startingRoom,
	inventory: _dnimmo$project_arklay_v2$Inventory$initModel,
	displayedMessage: _elm_lang$core$Maybe$Nothing,
	previousDirection: 'FromStart',
	examinedRooms: {ctor: '[]'}
};
var _dnimmo$project_arklay_v2$Game$Model = F5(
	function (a, b, c, d, e) {
		return {room: a, inventory: b, displayedMessage: c, previousDirection: d, examinedRooms: e};
	});
var _dnimmo$project_arklay_v2$Game$InventoryMsg = function (a) {
	return {ctor: 'InventoryMsg', _0: a};
};
var _dnimmo$project_arklay_v2$Game$ExamineRoom = function (a) {
	return {ctor: 'ExamineRoom', _0: a};
};
var _dnimmo$project_arklay_v2$Game$showExtraRoomOptions = function (model) {
	return ((!(_elm_lang$core$Native_Utils.eq(model.room.name, 'Start') || _elm_lang$core$Native_Utils.eq(model.room.name, 'End'))) && _elm_lang$core$Native_Utils.eq(model.inventory.open, false)) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('Separate'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: function () {
				var _p12 = model.displayedMessage;
				if (_p12.ctor === 'Just') {
					return A2(
						_elm_lang$html$Html$p,
						{ctor: '[]'},
					...
					return A2(
						...
						{
							ctor: '::',
							_0: (!A2(_elm_lang$core$List$member, model.room, model.examinedRooms)) ? _elm_lang$html$Html_Attributes$class('Selectable Examine') : _elm_lang$html$Html_Attributes$class('Selectable Examine AlreadyExamined'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_dnimmo$project_arklay_v2$Game$ExamineRoom(model.room)),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$examine),
							_1: {ctor: '[]'}
						});
				}
			}(),
			_1: {
				...
				_0: A2(
					...
					_dnimmo$project_arklay_v2$Game$InventoryMsg,
					_dnimmo$project_arklay_v2$Inventory$view(model.inventory)),
				_1: {ctor: '[]'}
			}
		}) : _dnimmo$project_arklay_v2$Game$displayNothing;
};
var _dnimmo$project_arklay_v2$Game$ChangeRoom = F2(
	function (a, b) {
		return {ctor: 'ChangeRoom', _0: a, _1: b};
	});
var _dnimmo$project_arklay_v2$Game$renderDirectionOptions = F2(
	function (direction, itemsUsed) {
		return A2(_dnimmo$project_arklay_v2$Game$roomIsOpen, direction, itemsUsed) ? A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(direction.text),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('Selectable'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							A2(_dnimmo$project_arklay_v2$Game$ChangeRoom, direction.destination, direction.text)),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(direction.text),
				_1: {ctor: '[]'}
			}) : A2(
			_elm_lang$html$Html$li,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('NotSelectable'),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _dnimmo$project_arklay_v2$Game$renderDirections = F2(
	function (availableDirections, itemsUsed) {
		return A2(
			_elm_lang$html$Html$ul,
			{
				ctor: '::',
			...
			A2(
				_elm_lang$core$List$map,
				function (direction) {
					return A2(_dnimmo$project_arklay_v2$Game$renderDirectionOptions, direction, itemsUsed);
				},
				availableDirections));
	});
var _dnimmo$project_arklay_v2$Game$showDirectionsOrInventory = function (model) {
	return (!model.inventory.open) ? A2(_dnimmo$project_arklay_v2$Game$renderDirections, model.room.availableDirections, model.inventory.itemsUsed) : A2(
		_elm_lang$html$Html$map,
		_dnimmo$project_arklay_v2$Game$InventoryMsg,
		_dnimmo$project_arklay_v2$Inventory$view(model.inventory));
};
var _dnimmo$project_arklay_v2$Game$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _dnimmo$project_arklay_v2$Game$renderRoomInfo(model),
			_1: {
				ctor: '::',
				_0: _dnimmo$project_arklay_v2$Game$showDirectionsOrInventory(model),
				_1: {
					ctor: '::',
					_0: _dnimmo$project_arklay_v2$Game$showExtraRoomOptions(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _dnimmo$project_arklay_v2$Style$AlreadyExamined = {ctor: 'AlreadyExamined'};
var _dnimmo$project_arklay_v2$Style$FromStart = {ctor: 'FromStart'};
var _dnimmo$project_arklay_v2$Style$FromDownstairs = {ctor: 'FromDownstairs'};
var _dnimmo$project_arklay_v2$Style$FromUpstairs = {ctor: 'FromUpstairs'};
var _dnimmo$project_arklay_v2$Style$FromEnter = {ctor: 'FromEnter'};
var _dnimmo$project_arklay_v2$Style$FromEast = {ctor: 'FromEast'};
var _dnimmo$project_arklay_v2$Style$FromWest = {ctor: 'FromWest'};
var _dnimmo$project_arklay_v2$Style$FromSouth = {ctor: 'FromSouth'};
var _dnimmo$project_arklay_v2$Style$FromNorth = {ctor: 'FromNorth'};
var _dnimmo$project_arklay_v2$Style$Separate = {ctor: 'Separate'};
var _dnimmo$project_arklay_v2$Style$Hidden = {ctor: 'Hidden'};
var _dnimmo$project_arklay_v2$Style$Button = {ctor: 'Button'};
var _dnimmo$project_arklay_v2$Style$Examine = {ctor: 'Examine'};
var _dnimmo$project_arklay_v2$Style$NotSelectable = {ctor: 'NotSelectable'};
var _dnimmo$project_arklay_v2$Style$Selectable = {ctor: 'Selectable'};
var _dnimmo$project_arklay_v2$Style$East = {ctor: 'East'};
var _dnimmo$project_arklay_v2$Style$West = {ctor: 'West'};
var _dnimmo$project_arklay_v2$Style$Downstairs = {ctor: 'Downstairs'};
var _dnimmo$project_arklay_v2$Style$Upstairs = {ctor: 'Upstairs'};
var _dnimmo$project_arklay_v2$Style$South = {ctor: 'South'};
var _dnimmo$project_arklay_v2$Style$North = {ctor: 'North'};
var _dnimmo$project_arklay_v2$Style$UserOptions = {ctor: 'UserOptions'};
var _dnimmo$project_arklay_v2$Style$RoomDescription = {ctor: 'RoomDescription'};
var _dnimmo$project_arklay_v2$Style$IntroAnimation = {ctor: 'IntroAnimation'};
var _dnimmo$project_arklay_v2$Style$MainContainer = {ctor: 'MainContainer'};
var _dnimmo$project_arklay_v2$Style$css = _rtfeldman$elm_css$Css$stylesheet(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css_Elements$html(
			{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css$fontSize(
						_rtfeldman$elm_css$Css$pct(62.5)),
					_1: {ctor: '[]'}
				}
			}),
		_1: {
			...
			_0: _rtfeldman$elm_css$Css_Elements$body(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(_dnimmo$project_arklay_v2$Constants$colourPalette1),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(_dnimmo$project_arklay_v2$Constants$colourPalette2),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$fontSize(
									_rtfeldman$elm_css$Css$rem(2.2)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$letterSpacing(
										_rtfeldman$elm_css$Css$rem(4.0e-2)),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: A2(_rtfeldman$elm_css$Css$property, 'transition', _dnimmo$project_arklay_v2$Constants$transition),
													_1: {ctor: '[]'}
												}
											}
										}
				...
				_0: _rtfeldman$elm_css$Css_Elements$h1(
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$fontWeight(_rtfeldman$elm_css$Css$lighter),
							_1: {
								ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									_dnimmo$project_arklay_v2$Style$IntroAnimation,
									{
										ctor: '::',
										_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'fadeIn 0.3s linear'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_dnimmo$project_arklay_v2$Style$RoomDescription,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$minHeight(
												_rtfeldman$elm_css$Css$vh(25)),
											_1: {
												ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_dnimmo$project_arklay_v2$Style$MainContainer,
											{
												ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_dnimmo$project_arklay_v2$Style$UserOptions,
												{
													ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$borderLeft(
																_rtfeldman$elm_css$Css$rem(0)),
															_1: {
																ctor: '::',
											...
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_dnimmo$project_arklay_v2$Style$North,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$adjacentSiblings(
															{
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_dnimmo$project_arklay_v2$Style$East,
																	{
																		ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_dnimmo$project_arklay_v2$Style$South,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$marginTop(
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_dnimmo$project_arklay_v2$Style$Downstairs,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$marginTop(
																					_rtfeldman$elm_css$Css$rem(4)),
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_dnimmo$project_arklay_v2$Style$Upstairs,
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$adjacentSiblings(
																{
													...
													_1: {
														...
														_0: A2(
															_rtfeldman$elm_css$Css$class,
															_dnimmo$project_arklay_v2$Style$West,
															{
																ctor: '::',
														...
														_1: {
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_dnimmo$project_arklay_v2$Style$Selectable,
																	{
																		ctor: '::',
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_dnimmo$project_arklay_v2$Style$NotSelectable,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$color(_dnimmo$project_arklay_v2$Constants$colourPalette3),
																			_1: {
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$textDecoration(_rtfeldman$elm_css$Css$lineThrough),
																				_1: {ctor: '[]'}
																			}
																		}),
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_dnimmo$project_arklay_v2$Style$Examine,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$marginTop(
																					_rtfeldman$elm_css$Css$rem(4)),
																		...
																		_1: {
																			...
																			_0: A2(
																				_rtfeldman$elm_css$Css$class,
																				_dnimmo$project_arklay_v2$Style$Hidden,
																				{
																					ctor: '::',
																			...
																			_1: {
																				...
																				_0: A2(
																					_rtfeldman$elm_css$Css$class,
																					_dnimmo$project_arklay_v2$Style$Button,
																					{
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$color(_dnimmo$project_arklay_v2$Constants$colourPalette2),
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$fontSize(
																									_rtfeldman$elm_css$Css$rem(2.4)),
																								_1: {
																									ctor: '::',
																									_0: _rtfeldman$elm_css$Css$letterSpacing(
																										_rtfeldman$elm_css$Css$rem(7.0e-2)),
																									_1: {
																										ctor: '::',
																										_0: _rtfeldman$elm_css$Css$margin(
																											_rtfeldman$elm_css$Css$rem(2)),
																															...
																															_1: {
																																...
																																_1: {
																																	...
																																	_0: _rtfeldman$elm_css$Css$hover(
																																		{
																																			ctor: '::',
																																			_0: _rtfeldman$elm_css$Css$backgroundColor(_dnimmo$project_arklay_v2$Constants$colourPalette2),
																																			_1: {
																																				ctor: '::',
																																				_0: _rtfeldman$elm_css$Css$color(_dnimmo$project_arklay_v2$Constants$colourPalette1),
																																				_1: {
																																					ctor: '::',
																																					_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$pointer),
																																					_1: {
																				...
																				_1: {
																					...
																					_0: A2(
																						_rtfeldman$elm_css$Css$class,
																						_dnimmo$project_arklay_v2$Style$Separate,
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$marginTop(
																					...
																					_1: {
																						...
																						_0: A2(
																							_rtfeldman$elm_css$Css$class,
																							_dnimmo$project_arklay_v2$Style$FromNorth,
																							{
																								ctor: '::',
																								_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideDown 0.2s linear'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_rtfeldman$elm_css$Css$class,
																								_dnimmo$project_arklay_v2$Style$FromSouth,
																								{
																									ctor: '::',
																									_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideUp 0.2s linear'),
																									_1: {ctor: '[]'}
																								}),
																							_1: {
																								ctor: '::',
																								_0: A2(
																									_rtfeldman$elm_css$Css$class,
																									_dnimmo$project_arklay_v2$Style$FromWest,
																									{
																										ctor: '::',
																										_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideRight 0.2s linear'),
																										_1: {ctor: '[]'}
																									}),
																								_1: {
																									ctor: '::',
																									_0: A2(
																										_rtfeldman$elm_css$Css$class,
																										_dnimmo$project_arklay_v2$Style$FromEast,
																										{
																											ctor: '::',
																											_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideLeft 0.2s linear'),
																											_1: {ctor: '[]'}
																										}),
																									_1: {
																										ctor: '::',
																										_0: A2(
																											_rtfeldman$elm_css$Css$class,
																											_dnimmo$project_arklay_v2$Style$FromEnter,
																											{
																												ctor: '::',
																												_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'scaleIn 0.6s linear'),
																												_1: {ctor: '[]'}
																											}),
																										_1: {
																											ctor: '::',
																											_0: A2(
																												_rtfeldman$elm_css$Css$class,
																												_dnimmo$project_arklay_v2$Style$FromDownstairs,
																												{
																													ctor: '::',
																													_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideUp 0.4s linear'),
																													_1: {ctor: '[]'}
																												}),
																											_1: {
																												ctor: '::',
																												_0: A2(
																													_rtfeldman$elm_css$Css$class,
																													_dnimmo$project_arklay_v2$Style$FromUpstairs,
																													{
																														ctor: '::',
																														_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'slideDown 0.4s linear'),
																														_1: {ctor: '[]'}
																													}),
																												_1: {
																													ctor: '::',
																													_0: A2(
																														_rtfeldman$elm_css$Css$class,
																														_dnimmo$project_arklay_v2$Style$FromStart,
																														{
																															ctor: '::',
																															_0: A2(_rtfeldman$elm_css$Css$property, 'animation', 'fadeIn 1s linear'),
																															_1: {ctor: '[]'}
																														}),
																													_1: {
																														ctor: '::',
																														_0: A2(
																															_rtfeldman$elm_css$Css$class,
																															_dnimmo$project_arklay_v2$Style$AlreadyExamined,
																															{
																																ctor: '::',
																																_0: _rtfeldman$elm_css$Css$color(_dnimmo$project_arklay_v2$Constants$colourPalette3),
																																_1: {ctor: '[]'}
...
var _dnimmo$project_arklay_v2$Intro$view = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('IntroAnimation'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$header),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$intro),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _dnimmo$project_arklay_v2$Main$displayNothing = _elm_lang$html$Html$text('');
var _dnimmo$project_arklay_v2$Main$Model = F2(
	function (a, b) {
		return {page: a, game: b};
	});
var _dnimmo$project_arklay_v2$Main$GamePage = {ctor: 'GamePage'};
var _dnimmo$project_arklay_v2$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'StartGame') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{page: _dnimmo$project_arklay_v2$Main$GamePage});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					game: A2(_dnimmo$project_arklay_v2$Game$update, _p0._0, model.game)
				});
		}
	});
var _dnimmo$project_arklay_v2$Main$IntroPage = {ctor: 'IntroPage'};
var _dnimmo$project_arklay_v2$Main$initModel = {page: _dnimmo$project_arklay_v2$Main$IntroPage, game: _dnimmo$project_arklay_v2$Game$initModel};
var _dnimmo$project_arklay_v2$Main$GameMsg = function (a) {
	return {ctor: 'GameMsg', _0: a};
};
var _dnimmo$project_arklay_v2$Main$StartGame = {ctor: 'StartGame'};
var _dnimmo$project_arklay_v2$Main$view = function (model) {
	var page = function () {
		var _p1 = model.page;
		if (_p1.ctor === 'IntroPage') {
			return _dnimmo$project_arklay_v2$Intro$view;
		} else {
			return A2(
				_elm_lang$html$Html$map,
				_dnimmo$project_arklay_v2$Main$GameMsg,
				_dnimmo$project_arklay_v2$Game$view(model.game));
		}
	}();
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Native_Utils.eq(model.page, _dnimmo$project_arklay_v2$Main$IntroPage) ? A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_dnimmo$project_arklay_v2$Main$StartGame),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_dnimmo$project_arklay_v2$SiteText$startButton),
						_1: {ctor: '[]'}
					}) : _dnimmo$project_arklay_v2$Main$displayNothing,
				_1: {ctor: '[]'}
			}
		});
};
var _dnimmo$project_arklay_v2$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _dnimmo$project_arklay_v2$Main$initModel, view: _dnimmo$project_arklay_v2$Main$view, update: _dnimmo$project_arklay_v2$Main$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _dnimmo$project_arklay_v2$Main$main !== 'undefined') {
    _dnimmo$project_arklay_v2$Main$main(Elm['Main'], 'Main', undefined);
}
